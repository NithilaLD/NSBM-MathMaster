      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        >
          <div className="bg-gradient-to-br from-[#6366f1] to-[#3b82f6] text-white text-center mb-8 rounded-2xl p-6">
            ...
            <h1 className="text-3xl font-bold">MathMaster Competition</h1>
            <p className="text-gray-100 mt-2">Inter-School Mathematics Competition</p>
          </div>
                ...
                <div className="mb-4">
                  ...
                  <Select value={formData.school} onValueChange={handleSchoolChange}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="Bandaranayake Central College, Gampaha">Bandaranayake Central College, Gampaha</SelectItem>
                      ...
                      <SelectItem value="Bomiriya Central College, Kaduwela">Bomiriya Central College, Kaduwela</SelectItem>
                      ...
                      <SelectItem value="St. Bridget's Convent, Colombo">St. Bridget's Convent</SelectItem>
                      <SelectItem value="St. Joseph's Boys' College, Nugegoda">St. Joseph's Boys' College, Nugegoda</SelectItem>
                      ...
                      <SelectItem value="Saiva Mangaiyar Vidyalayam, Colombo 06">Saiva Mangaiyar Vidyalayam, Colombo 06</SelectItem>
                      <SelectItem value="Khairiya Girl's College Colombo-9">Khairiya Girl's College Colombo-9</SelectItem>
                      <SelectItem value="St. Joseph's College, Colombo 10">St. Joseph's College, Colombo 10</SelectItem>
                      <SelectItem value="Siripiyarathana Central College, Padukka, Colombo">Siripiyarathana Central College, Padukka, Colombo</SelectItem>
                      <SelectItem value="St Thomas Catholic International College Seeduwa">St Thomas Catholic International College Seeduwa</SelectItem>
                      <SelectItem value="Veyangoda Central College, Veyangoda">Veyangoda Central College, Veyangoda</SelectItem>
                    </SelectContent>
                  </Select>
                </div>

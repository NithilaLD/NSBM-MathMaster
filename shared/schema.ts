...
export const schoolEnum = pgEnum("school", [
  ...
  "Bandaranayake Central College, Gampaha",
  ...
  "Other",
  "Saiva Mangaiyar Vidyalayam, Colombo 06",
  "Khairiya Girl's College Colombo-9",
  "St. Joseph's College, Colombo 10",
  "Siripiyarathana Central College, Padukka, Colombo",
  "St Thomas Catholic International College Seeduwa",
  "Veyangoda Central College, Veyangoda",
]);
